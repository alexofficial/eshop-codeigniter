<center>
 <?php 
/*
 *  This php file is for admin statistics logins per day.
 */
//----------------------------------------------------------------------------//
?>
<script>
      ...
      function drawChart() {var data = google.visualization.arrayToDataTable([
	   <?php
	   $str=" ['Day', 'Day'] ";
	   $query="select numbers as nu, DATE_FORMAT( date, '%y-%b-%d' ) as dat"
                   . " from statistics_logins_per_day order by date ASC";   
...
var chart =
    ...
    <div id="printableArea">
       <p style="font-size:30px;" id="products_color">Logins per day Stats</p>
