...
<?php 
/*
 *  This php file is for admin statistics register per day.
 */
//----------------------------------------------------------------------------//
?>
<script>
      ...
      function drawChart() {var data = google.visualization.arrayToDataTable([
	   <?php
	   $str=" ['Day', 'Day'] ";
	   $query="select numbers as nu, DATE_FORMAT( date, '%y-%b-%d' ) as "
                   . "dat from statistics_register_per_day order by date ASC";   
...
var chart = 
    ...
    <div id="printableArea">
       <p style="font-size:30px;" id="products_color">Register per day Stats</p>
