<?php
/*
 *  This php file is for view of logged user product panel
 */
?>
	...
	?>
<center> 
    <?php echo form_open('User_page_controller/update_shop_cart?category_name='
            . $category); ?>
...
//----------------------------------------------------------------------------//
        ...
        echo form_submit('final_shop_add', 'Finish shop',
                'class="delete_button"');
        echo form_close();
        echo "</th>";
//----------------------------------------------------------------------------//
